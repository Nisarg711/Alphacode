      ...
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 bg-gradient-to-br from-purple-600 to-purple-800 p-12 flex flex-col justify-center items-center text-white">
            ...
            <p className="text-lg text-center text-purple-200">Welcome Back!</p>
          </div>

          <div className="md:w-1/2 p-8 md:p-12">
            <div className="max-w-md mx-auto">
              <h1 className="text-3xl font-bold text-gray-800 mb-2">Log In</h1>
              <p className="text-gray-600 mb-8">Sign in to continue coding</p>
              ...
              <div className="mt-6">
                ...
                <div className="mt-6 flex justify-center">
                  <img 
                    ...
                    className="w-48 cursor-pointer hover:opacity-80 transition duration-200"
                    onClick={() => login()}
                  />
                </div>
              </div>
              ...
              <p className="mt-8 text-center text-sm text-gray-600">
                New User?{' '}
                <a href="/signup" target="_blank" className="text-purple-600 hover:text-purple-700 font-semibold hover:underline">
                  Register here
                </a>
              </p>
            </div>
